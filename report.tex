...
The RandomForest model achieved the following metrics:
\begin{itemize}
    \item RMSE: Approximately 1600 seconds
    \item The most important features were distance and geographic coordinates
\end{itemize}
